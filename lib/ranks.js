...
const TIERS = [
  { name: 'Non classé', emoji: '⚪', winsToPromote: 5 },
  { name: 'Bronze 1', emoji: '🥉', winsToPromote: 10 },
  { name: 'Bronze 2', emoji: '🥉', winsToPromote: 10 },
  { name: 'Bronze 3', emoji: '🥉', winsToPromote: 10 },
  { name: 'Argent 1', emoji: '🥈', winsToPromote: 15 },
  { name: 'Argent 2', emoji: '🥈', winsToPromote: 15 },
  { name: 'Argent 3', emoji: '🥈', winsToPromote: 15 },
  { name: 'Or 1', emoji: '🥇', winsToPromote: 20 },
  { name: 'Or 2', emoji: '🥇', winsToPromote: 20 },
  { name: 'Or 3', emoji: '🥇', winsToPromote: 20 },
  { name: 'Platine 1', emoji: '🔷', winsToPromote: 25 },
  { name: 'Platine 2', emoji: '🔷', winsToPromote: 25 },
  { name: 'Platine 3', emoji: '🔷', winsToPromote: 25 },
  { name: 'Diamant 1', emoji: '💎', winsToPromote: 30 },
  { name: 'Diamant 2', emoji: '💎', winsToPromote: 30 },
  { name: 'Diamant 3', emoji: '💎', winsToPromote: 30 },
  { name: 'Élite 1', emoji: '🌟', winsToPromote: 35 },
  { name: 'Élite 2', emoji: '🌟', winsToPromote: 35 },
  { name: 'Élite 3', emoji: '🌟', winsToPromote: 35 },
  { name: 'Champion 1', emoji: '🏆', winsToPromote: 40 },
  { name: 'Champion 2', emoji: '🏆', winsToPromote: 40 },
  { name: 'Champion 3', emoji: '🏆', winsToPromote: 40 },
  { name: 'Unreal 1', emoji: '⚡', winsToPromote: 45 },
  { name: 'Unreal 2', emoji: '⚡', winsToPromote: 45 },
  { name: 'Unreal 3', emoji: '⚡', winsToPromote: 45 },
  { name: 'Unreal Legend 1', emoji: '👑', winsToPromote: 50 },
  { name: 'Unreal Legend 2', emoji: '👑', winsToPromote: 50 },
  { name: 'Unreal Legend 3', emoji: '👑', winsToPromote: null },
];
...
function publicProfile(p) {
  ...
  return {
    ...
    ownedBalls: p.ownedBalls || ['classique'],
    selectedBall: p.selectedBall || 'classique',
    ownedKeepers: p.ownedKeepers || ['classique'],
    selectedKeeper: p.selectedKeeper || 'classique',
    ownedPowers: p.ownedPowers || [],
    selectedPower: p.selectedPower || null,
  };
}
