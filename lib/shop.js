...
// "pattern" dit à game.js QUEL dessin utiliser. Le ballon est minuscule à
// l'écran, donc on privilégie des formes grandes et franches (peu de
// pièces, bien visibles) plutôt que des détails fins qui deviennent
// illisibles en petit : pentagon = ballon noir/blanc classique, petalsN =
// tourbillon à N pointes (grandes formes, se voit bien), teamgeist =
// tourbillon noir central.
const BALLS = {
  classique: { name: 'Ballon CDM 2026', price: 0, pattern: 'petals3', colors: ['#FFC72C', '#D6001C', '#1751B4'] },
  cdm2022: { name: 'Ballon CDM 2022 (Al Rihla)', price: 50, pattern: 'wave', colors: ['#F7F9FA', '#FF6B35', '#003DA5'] },
  cdm2018: { name: 'Ballon CDM 2018 (Telstar 18)', price: 100, pattern: 'pentagon', colors: ['#1A1A1A', '#F7F9FA', '#00A19A'] },
  cdm2014: { name: 'Ballon CDM 2014 (Brazuca)', price: 200, pattern: 'petals5', colors: ['#F7941D', '#00A651', '#0072BC'] },
  cdm2010: { name: 'Ballon CDM 2010 (Jabulani)', price: 300, pattern: 'petals6', colors: ['#00A651', '#F7941D', '#0072BC'] },
  cdm2006: { name: 'Ballon CDM 2006 (Teamgeist)', price: 500, pattern: 'teamgeist', colors: ['#1A1A1A', '#FFC72C', '#F7F9FA'] },
  cdm2002: { name: 'Ballon CDM 2002 (Fevernova)', price: 600, pattern: 'petals3', colors: ['#FFC72C', '#D6001C', '#F7F9FA'] },
  cdm1998: { name: 'Ballon CDM 1998 (Tricolore)', price: 800, pattern: 'tricolore', colors: ['#002395', '#F7F9FA', '#ED2939'] },
  cdm1994: { name: 'Ballon CDM 1994 (Questra)', price: 1000, pattern: 'star', colors: ['#3C3B6E', '#F7F9FA', '#B22234'] },
  cdm1990: { name: 'Ballon CDM 1990 (Etrusco)', price: 2000, pattern: 'pentagon', colors: ['#000000', '#F7F9FA', '#008C45'] },
};
...
// Pouvoirs : achetés une fois avec des diamants, utilisables ensuite une
// fois par match (état "déjà utilisé ce match" géré dans api/room.js).
// "effect" dit à api/room.js quel calcul appliquer au moment du tir.
const POWERS = {
  tir_surprise: {
    name: 'Tir Surprise', price: 200, effect: 'harder_save',
    description: 'Le ballon change de trajectoire au dernier moment : plus dur à arrêter pour le gardien.',
  },
};

const CATALOGS = { ball: BALLS, keeper: KEEPERS, power: POWERS };
const OWNED_FIELD = { ball: 'ownedBalls', keeper: 'ownedKeepers', power: 'ownedPowers' };
const SELECTED_FIELD = { ball: 'selectedBall', keeper: 'selectedKeeper', power: 'selectedPower' };
const DEFAULT_OWNED = { ball: ['classique'], keeper: ['classique'], power: [] };
...
async function buyItem(redis, username, kind, itemId) {
  ...
  profile[ownedField] = profile[ownedField] || DEFAULT_OWNED[kind].slice();
...
module.exports = { BALLS, KEEPERS, POWERS, DIAMONDS_PER_MATCH, addDiamonds, buyItem, selectItem };
