...
const BALLS = {
  classique: { name: 'Ballon CDM 2026', price: 0, colors: ['#FFC72C', '#D6001C', '#1751B4'] },
  cdm2022: { name: 'Ballon CDM 2022', price: 50, colors: ['#E7E7E9', '#C8102E', '#003DA5'] },
  cdm2018: { name: 'Ballon CDM 2018', price: 100, colors: ['#00A19A', '#1A1A1A', '#E8E8E8'] },
  cdm2014: { name: 'Ballon CDM 2014', price: 200, colors: ['#F7941D', '#00A651', '#0072BC'] },
  cdm2010: { name: 'Ballon CDM 2010', price: 300, colors: ['#00A651', '#F7941D', '#0072BC'] },
  cdm2006: { name: 'Ballon CDM 2006', price: 500, colors: ['#1A1A1A', '#FFC72C', '#F7F9FA'] },
  cdm2002: { name: 'Ballon CDM 2002', price: 600, colors: ['#FFC72C', '#D6001C', '#F7F9FA'] },
  cdm1998: { name: 'Ballon CDM 1998', price: 800, colors: ['#002395', '#F7F9FA', '#ED2939'] },
  cdm1994: { name: 'Ballon CDM 1994', price: 1000, colors: ['#B22234', '#F7F9FA', '#3C3B6E'] },
  cdm1990: { name: 'Ballon CDM 1990', price: 2000, colors: ['#008C45', '#F7F9FA', '#CD212A'] },
};
